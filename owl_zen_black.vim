if &background == 'dark'
  ...
  let s:guishade1 = "#303030"
  let s:guishade2 = "#454545"
  let s:guishade3 = "#5e5e5e"
  let s:guishade4 = "#757575"
  let s:guishade5 = "#7d7d7d"
  let s:guishade6 = "#949494"
  let s:guishade7 = "#DBDEE7"
  let s:guiaccent0 = "#814d1b"
  let s:guiaccent1 = "#DBDEE7"
  let s:guiaccent2 = "#DBDEE7"
  let s:guiaccent3 = "#78000e"
  let s:guiaccent4 = "#DBDEE7"
  let s:guiaccent5 = "#2a5c04"
  let s:guiaccent6 = "#adadad"
  let s:guiaccent7 = "#513f52"
...
highlight clear
syntax reset
let g:colors_name = "owl_zen_black"
