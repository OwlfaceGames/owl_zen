if &background == 'dark'
  let s:guishade0 = "#002322"
  let s:guishade1 = "#19332E"
  let s:guishade2 = "#324339"
  let s:guishade3 = "#4B5345"
  let s:guishade4 = "#646351"
  let s:guishade5 = "#7D735D"
  let s:guishade6 = "#968368"
  let s:guishade7 = "#AF9374"
  let s:guiaccent0 = "#D9AA1A"
  let s:guiaccent1 = "#AF9374"
  let s:guiaccent2 = "#AF9374"
  let s:guiaccent3 = "#567425"
  let s:guiaccent4 = "#AF9374"
  let s:guiaccent5 = "#DBDEE7"
  let s:guiaccent6 = "#AF9374"
  let s:guiaccent7 = "#C48B43"
