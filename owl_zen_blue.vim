if &background == 'dark'
  let s:guishade0 = "#122046"
  let s:guishade1 = "#313187"
  let s:guishade2 = "#40406b"
  let s:guishade3 = "#6060a1"
  let s:guishade4 = "#7b7ba8"
  let s:guishade5 = "#7d7d7d"
  let s:guishade6 = "#949494"
  let s:guishade7 = "#DBDEE7"
  let s:guiaccent0 = "#94874d"
  let s:guiaccent1 = "#DBDEE7"
  let s:guiaccent2 = "#DBDEE7"
  let s:guiaccent3 = "#765780"
  let s:guiaccent4 = "#DBDEE7"
  let s:guiaccent5 = "#2F4F4F"
  let s:guiaccent6 = "#adadad"
  let s:guiaccent7 = "#b07248"
  let s:ctermshade0 = 23
  let s:ctermshade1 = 23
  let s:ctermshade2 = 59
  let s:ctermshade3 = 65
  let s:ctermshade4 = 102
  let s:ctermshade5 = 102
  let s:ctermshade6 = 144
  let s:ctermshade7 = 144
  let s:ctermaccent0 = 179
  let s:ctermaccent1 = 144
  let s:ctermaccent2 = 144
  let s:ctermaccent3 = 101
  let s:ctermaccent4 = 144
  let s:ctermaccent5 = 189
  let s:ctermaccent6 = 144
  let s:ctermaccent7 = 179
endif

highlight clear
syntax reset
let g:colors_name = "owl_zen_blue"
...
" Treesitter groups
exec "hi @variable guifg=".s:guiaccent1
exec "hi @operator guifg=".s:guiaccent1
exec "hi @punctuation guifg=".s:guiaccent1
exec "hi @string guifg=".s:guiaccent0
exec "hi @type.builtin guifg=".s:guiaccent5
